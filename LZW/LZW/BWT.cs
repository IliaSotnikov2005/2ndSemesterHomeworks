...
{
    /// <summary>
    /// Class <c>BWT</c> contains methods for direct and reverse BWT string conversion.
    /// </summary>
    public static class BWT
    {
        ...
        /// <param name="indexOfStart">Index of the first symbol is the original string.</param>
